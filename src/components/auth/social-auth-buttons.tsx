...
function SocialAuthButtonsComponent({ onGoogleClick, onGitHubClick, isLoading }: SocialAuthButtonsProps) {
  return (
...
export const SocialAuthButtons = withPerformanceOptimization<SocialAuthButtonsProps>({
  name: 'SocialAuthButtons',
  trackProps: true,
  trackRenders: true,
  metricType: 'render',
  slowThreshold: 50
})(React.memo(SocialAuthButtonsComponent)); 